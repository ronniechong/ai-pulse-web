...
deployed via GitHub Actions + GitHub Pages at
[ronniechong.com/ai-pulse-web/](https://ronniechong.com/ai-pulse-web/).
Fetches versioned JSON snapshots at runtime from the `ai-pulse-data` repo —
no rebuild needed when the data updates.
